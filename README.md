...
It is pretty clear from these examples that the syntax of Dart is way more simple and compact than in Java.
In Dart, code can be defined inside, as well as outside the classes.
[here](https://github.com/anuj0809/Dart-Important/blob/master/Bicycle.dart)
...
A simple program to explain the variables above can be found 
[here](https://github.com/anuj0809/Dart-Important/blob/master/variables.dart).
...
A program to demonstrate this is
[here](https://github.com/anuj0809/Dart-Important/blob/master/variables2.dart).
...
```
View [this](https://github.com/anuj0809/Dart-Important/blob/master/numbers.dart) program to see how numbers can be used in dart.
...
[Here](https://github.com/anuj0809/Dart-Important/blob/master/strings1.dart) is program to check out these things.
...
```
A program to demonstrate the lists concepts is [here](https://github.com/anuj0809/Dart-Important/blob/master/lists.dart).
...
Run [this](https://github.com/anuj0809/Dart-Important/blob/master/maps.dart) program to see the properties of maps.
...
Check out [this](https://github.com/anuj0809/Dart-Important/blob/master/runes.dart) program to see runes in action.
...
[Here](hhttps://github.com/anuj0809/Dart-Important/blob/master/Bicycle2.dart) is a basic program which will explain getters and demonstrates read only variables in Dart.
